"""
Panel de Opciones Avanzadas para QA - Versión Simplificada
Solo generación de casos de prueba, sin exportación automática
"""
import sys
...
class PanelQAAvanzado(QDialog):
    ...
    def configurar_ui(self):
        ...
        # BOTONES INFERIORES SIMPLIFICADOS
    ...
    def configurar_tab_documentacion(self, tab):
        ...
        herramientas = [
            ...
            ("📝 Casos de Prueba → Notion", "Genera casos formato Notion con emojis optimizados", self.generar_casos_notion),
...
**REQUISITOS:** Mínimo 15-20 casos, fechas DD/MM/YYYY, prioridades equilibradas, ambos formatos incluidos.""")
    ...
    def mostrar_ayuda(self):
        ...
        <div style='font-family: Segoe UI; color: #1F2937; background-color: #FFFFFF; padding: 20px; border-radius: 15px;'>
            ...
            <h3 style='color: #DC2626;'>⭐ FUNCIONALIDADES DESTACADAS:</h3>
            <ul style='color: #1F2937; line-height: 1.8; font-size: 15px;'>
                <li><strong>📖 Manual de Usuario:</strong> Genera manuales completos y profesionales</li>
                <li><strong>📝 Casos para Notion:</strong> Formato optimizado con emojis para Notion</li>
                <li><strong>🗂️ Casos JSON:</strong> Formato estructurado para gestión de proyectos</li>
                <li><strong>✅ Casos BDD:</strong> Formato Gherkin para Cucumber/SpecFlow</li>
                <li><strong>📋 Planes de Prueba:</strong> Siguiendo estándar IEEE 829</li>
                <li><strong>🎯 Estrategias QA:</strong> Approach integral para testing</li>
            </ul>
            ...
            <ul style='color: #1F2937; line-height: 1.8; font-size: 15px;'>
                ...
                <li><strong>Formato Notion:</strong> Copia y pega directamente manteniendo emojis</li>
            </ul>
        </div>
        """
